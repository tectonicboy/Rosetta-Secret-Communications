...
server: | build_dir
	...
	$(CFLAGS) $(CSTD) $(ARCHITECTURE_FLAGS) $(GNU_OPTIMIZATION_FLAGS) $(EXTRA_FLAGS) \
	$(LDFLAGS) $(LDLIBS)

client: | build_dir
	$(CXX) $(ROSETTA_CLIENT_SRC) -o $(BIN_DIR)/$(ROSETTA_CLIENT_BIN) \
	$(OPTIMIZATION_LEVEL) $(COMPILER_OPTIMIZATION_REPORT) $(CXXFLAGS) $(CXXSTD) \
	$(ARCHITECTURE_FLAGS) $(GNU_OPTIMIZATION_FLAGS) $(EXTRA_FLAGS) $(WX_WIDGETS_SPECIFIC) $(LDFLAGS) $(LDLIBS)
...
client_asan: | build_dir
	...
	$(OPTIMIZATION_LEVEL) $(COMPILER_OPTIMIZATION_REPORT) $(CXXFLAGS) $(CXXSTD) \
	$(ARCHITECTURE_FLAGS) $(ADDRESS_SANITIZER_FLAGS) $(EXTRA_FLAGS) $(WX_WIDGETS_SPECIFIC) $(LDFLAGS) $(LDLIBS)
